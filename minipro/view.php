...
// Ensure the user is logged in before displaying this page
...
// Include this inside the body where the "Back" button is displayed
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<center>
    <!-- Dynamically redirect back to the faculty's dashboard page -->
    <div class="back">
        <a href="dashboard.php?faculty_name=<?php echo urlencode($faculty_name); ?>">BACK</a>
    </div>
</center>
